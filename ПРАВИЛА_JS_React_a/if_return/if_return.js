...
------------------------------------------------------------------------------------------------------------------------------------------
4) "return В циклах": не важно где ретурн всегда выход из непосредстенной функции внутри которой он происходит:
function isUnique(string) {
   ...
   for(let char of string) {
       if(unique.has(char)) {
           ...
           unique.add(char)
           // return true -- тут нельзя писать тк возвращаем true сразу после добавления первого символа на первои или "n" итерации
       }
   }

   return true // тоже выход из функции (не в итерации)
   //
}
