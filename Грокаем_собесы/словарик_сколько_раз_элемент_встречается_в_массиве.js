...
const countElements = (array) => {
  return array.reduce((objCount, element) => {
    // оператор "+" главнее чем "=", поэтому читается (выполняется) сначала выражение справа, objCount[element] - это значение свойства -
    // если значения нет: например: let objCount = {} - тут нет внутри никакого значения свойиства при первои итерации - значит "0", когжа
    // встретим "kiwi", то сделаем так - увеличим значение своиства objCount[element] --> let objCount = {kiwi: 1} - далее все остальные
    // итерации массива array
