/*
--> ПРАВИЛА "EVENT_LOOP":
- отделяем код строчками чтобы глазу понятнее было читать..
- пишем коммент "//" и пимем ответ: // 1 6 3 5 2... Когда много кода то что решили можно "закомментить.."
- setTimeout внутри "микротаски" выполнится после обычнного setTimeout
