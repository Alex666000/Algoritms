...
// resolve() - синхронен, но внутри setTimeout работает как "микротаска"
// -----------------------------------------------------------------------------------------------------------------------------------
// 3 задача:
console.log(1);
setTimeout(() => console.log(2));
...
// resolve - синхронен, если он в таимауте то асинхронене
 */
// -------------------------------------------------------------------------------------------------------------------------------------
// 4 задача:
const run = () => {
...
// // 1 Promise 4 777 then1 then2 timeOut2
// timeOut - нет в консоли тк функция не вызывается
// ---------------------------------------------------------------------------------------------------------------------------------------
console.log(1);
setTimeout(() => console.log(2));
...
// 1 6 3 2 7 8 (5 не выводится тк не попадает в аргументы then() )
// Макрозадачи выполняются в том порядке, в котором они были добавлены в очередь.
// Макрозадача внутри микро выполняется в конце
// ----------------------------------------------------------------------------------------------------------------------------------------
console.log(1);
