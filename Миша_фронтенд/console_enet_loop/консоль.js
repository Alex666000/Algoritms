...
Promise.reject('a')
  ...
  .then(p => p + 'd')// оба зена выполняются после catch тк первый catch уже обработал промис в состоянии "rejected", и он уже не в
  // состоянии "rejected", а снова в "fullfiled"
...
/*
ОТВЕТ:
- сначала отработает синхронный код - это "f" - далее abd - один раз кетч отрабатывает
 */
// -----------------
