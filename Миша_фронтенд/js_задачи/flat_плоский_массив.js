 ...
 */
// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Без рекурсии: ОЧЕРЕДЬ: // Сначала надо все распылить и превратить "не в массив" - потом не массивы попадут в "else" - рез выведется!
const flatten = (...args) => {
  ...
  while (queue.length) {
    ...
    if (Array.isArray(item)) {
      ...
      // Сначала мы все развернули и превратили не в массив - потом не массивы попадут в else
      queue.push(...item);
    } else {
