...
/*
Каррирование_преобразуем функцию f(a, b, c), значит вызов функции f(a) вернул другую функцию, - её вызываем с параметром b,
потом возвращается третья новая функция ее вызываем с параметром с,
